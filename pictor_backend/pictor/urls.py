...
from pictor.api import Authentication, ActionLogViewSet, NotificationRuleViewSet, NotificationViewSet, ProjectViewSet,\
    ...
    AnalysisParameterViewSet, AnalysisTaskInterfaceViewSet, SequencingTaskInterfaceViewSet, AnnouncementViewSet, \
    AnalysisSerialNumberSettingViewSet, ProjectSerialNumberSettingViewSet, SampleSerialNumberSettingViewSet, \
    SequencingSerialNumberSettingViewSet, StatisticViewSet
...
router_v1.register('analysis-modules', AnalysisModuleViewSet, basename='analysis_modules')
...
router_v1.register('seq_task_interface', SequencingTaskInterfaceViewSet, basename='seq_task_interface')
...
router_v1.register('sequencing_nums', SequencingSerialNumberSettingViewSet, basename='sequencing_nums')
