      ...
      <div>
        ...
        <el-steps :active="active" align-center finish-status="success">
          ...
          <el-step
            ...
            description="填写分析参数"
          ></el-step>
          <el-step v-else title="步骤2" description="修改分析参数"></el-step>
          <el-step
            v-if="edit_type === 'create'"
            title="步骤3"
            description="生成分析任务并启动"
          ></el-step>
          <el-step v-else title="步骤3" description="确认修改"></el-step>
        </el-steps>
        <div>
              ...
              >
                ...
                >
                  <el-select
                    ...
                    placeholder="请选择所属项目"
                    :disabled="edit_type === 'update' && project_instance"
...
export default {
  ...
  methods: {
    ...
    setFullCommand() {
      this.full_command = `${this.form.command} `;
